...
export default function CreateStore() {
  ...
  const fetchSellerStatus = async () => {
    try {
      ...
      console.error("FETCH_SELLER_STATUS_ERROR:", error);
  ...
  const onSubmitHandler = async (e) => {
    ...
    setMessage("Your store application has been submitted and is under review.");
          ...
          <form
            onSubmit={(e) =>
              toast.promise(onSubmitHandler(e), {
                ...
                error: (err) => err.message || "Failed to submit store",
              })
            }
          ...
          >
            <div>
              ...
              <p className="max-w-lg">
                To become a seller on E-Bazaar, submit your store details for
